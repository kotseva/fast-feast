...
public struct PersistenceController {
  ...
  private static func appGroupFileURL() -> URL {
    let appGroupDirectoryUrl: URL = FileManager.default
      .containerURL(forSecurityApplicationGroupIdentifier: "group.com.angelakoceva.Fasting.data")
      .unsafelyUnwrapped
  ...
  private init(transactionAuthor: String?, contextName: String?, inMemory: Bool = false) {
    ...
    guard let objectModelUrl = Bundle(identifier: "com.angelakoceva.FastStorage")?.url(forResource: "Fasting", withExtension: "momd") else {
